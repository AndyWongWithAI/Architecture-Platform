...
from .core_thoughts import router as core_thoughts_router  # REQ-968b1c99 / ADR-0003 2026-06-27
...
api_router.include_router(core_thoughts_router, prefix="/api/v1/core-thoughts", tags=["core-thoughts"])  # REQ-968b1c99
