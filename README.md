...
- **[docs/ai-assets-integration.md](docs/ai-assets-integration.md)** — 架构平台 + AI-Assets 双层结构说明
...
| **复用原则** | L0-L3 分层 + 原子/复合组件 + `is_asset`/`distribution_form`/`knowledge_artifact` 三维资产判定 + GitHub Packages 发包 + `arch use/tree/outdated` 命令 |
